  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Foeto Care",style: GoogleFonts.barlow(fontSize: screenSize.height*0.3*0.09,fontWeight: FontWeight.w500),),
      ),
      body: SafeArea(
        child: Container(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        Text(
                          "Average heart rate over the whole day is 79 BPM",
                          style: GoogleFonts.barlow(
                    ...
                    children: [
                      Container(
                        ...
                        child: Center(
                          child: TextButton(
                            style: ButtonStyle(
                              overlayColor: MaterialStateProperty.all(Colors.white.withAlpha(80)),
                            ...
                            child: Row(
                              ...
                              children: [
                                Text(
                                  " CALL ",
                                  style: GoogleFonts.barlow(fontSize: screenSize.height*0.02,
                                      color: Colors.white,
                      ...
                      Container(
                        ...
                        child: Center(
                          child: TextButton(
                            ...
                            onPressed: () => launch("https://www.google.com/maps/place/Apollo+Speciality+Hospitals+Vanagaram/@13.0707104,80.1484316,17z/data=!3m1!4b1!4m5!3m4!1s0x3a52617b16c5b051:0xa67384e8a225f370!8m2!3d13.0707104!4d80.1506203"),
                          ),
                        ),
                      ),
                    ],
